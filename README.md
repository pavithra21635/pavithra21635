...
- **Frontend:** Angular, JavaScript, TypeScript, HTML/CSS, React JS, HTML, CSS , JS , Bootstrap, Razor Views
- **Database:** SMS SQL Server, MySQL, Mongo DB, Azure, Firebase
- **Desktop/Mobile:** WPF (C#), Swift (iOS), Android 
- **Design/Tools:** Figma, Swagger, Git,  Bitbucket, Zoho, Jira
